...
2. Trace the operational path.
   ...
   - Backpressure.
   - Queue growth.
   - Partial failure between systems.
   - Recovery after restart or deploy.

3. Demand observability that answers real questions.
   - Would we know this is broken?
   - Would we know why?
   - Would we know who is affected?
   - Would we know whether recovery worked?

4. Prefer graceful failure over hidden corruption.
   - Explicit degradation beats fake success.
