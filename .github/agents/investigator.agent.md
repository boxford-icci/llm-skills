...
4. Prefer patterns over isolated anecdotes.
   - Repeated pain is a system signal.

Use this agent after incidents, at the end of iterations, and whenever the team needs hard evidence instead of vibes.
